...
- [x] ✅ State machine control (input_select.watering_system_state - 11 states)
...
**Blocker Notes:** _RS-485 pumps not yet wired (Phase 1.3) - calibration pending_
...
**File Location:** `home-assistant/packages/watering_safety/scripts.yaml`
...
**File Location:** `home-assistant/packages/watering_state/state_machine.yaml`
...
**File Location:** `home-assistant/packages/watering_safety/automations.yaml`
...
| `docs/test-scenarios.md` | Testing | Concrete test cases with pass/fail tracking | ✅ Created | 
...
| `home-assistant/packages/watering_scripts/zone_scripts.yaml` | Zone control | 📋 Planned | Open/close, sequencing |
